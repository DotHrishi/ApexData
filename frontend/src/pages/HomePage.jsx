...
const HomePage = () => {
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="relative min-h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-white px-10 pt-40 max-w-4xl">
          ...
          <div className="flex flex-row gap-4">
            <button onClick={() => window.location.href="/analytics"} className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-blue-600 px-6 font-medium text-neutral-200 cursor-pointer">
            ...
            <button onClick={() => window.location.href="/news"} className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-emerald-600 px-6 font-medium text-neutral-200 cursor-pointer">
      ...
      <div className="p-12 w-full bg-black border-t border-zinc-800">
        <h1 className="text-3xl font-bold orbitron text-white">Latest Results</h1>
      </div>

      <div className="py-20 relative z-20 bg-black">
        <div className="flex flex-col md:flex-row items-center">
          <div className="bg-emerald-500 w-full md:w-[35%] rounded-r-xl p-12 shadow-xl">
            <h2 className="text-3xl font-bold text-black orbitron">
              Why Choose ApexData?
            </h2>
          </div>
          <div className="w-full md:w-[65%]">
            <div className="max-w-4xl ml-auto px-8">
              <ul className="list-decimal list-outside pl-6 marker:text-red-600 space-y-4 text-lg orbitron text-zinc-200">
      ...
      >
        ...
        <h1 className="relative z-10 text-5xl font-bold orbitron">
          Apex<span className="text-red-500">Data</span>
        </h1>

        <p className="relative z-10 max-w-4xl mt-10 text-lg text-zinc-300 leading-relaxed">
